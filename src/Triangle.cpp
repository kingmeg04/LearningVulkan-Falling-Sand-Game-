...
struct Vertex {
    ...
    // Overload == to allow custom operations
    bool operator==(const Vertex& other) const {
        return pos == other.pos && color == other.color && texCoord == other.texCoord;
    }
};
// Fix for unordered map constructor
namespace std {
...
public:
    const std::string COMPILER_OUT = "../cmake-build-debug/";
...
private:
    ...
    void createGraphicsPipeline() {
        auto vertShaderCode = readFile(COMPILER_OUT + "shaders/shader4.vert.spv");
        auto fragShaderCode = readFile(COMPILER_OUT + "shaders/shader4.frag.spv");
    ...
    */
    ...
    void createTextureImage() {
        ...
        // Assign mipLevels after we've loaded the texture
        ...
        generateMipmaps(commandBuffer, textureImage, VK_FORMAT_R8G8B8A8_SRGB, texWidth, texHeight, mipLevels);
    ...
    void generateMipmaps(VkCommandBuffer commandBuffer, VkImage image, VkFormat imageFormat, int32_t texWidth, int32_t texHeight, uint32_t mipLevels) {
        ...
        for (uint32_t i = 1; i < mipLevels; i++) {
            ...
            // Blit previous mip into current mip
            VkImageBlit blit{};
    ...
    void loadModel() {
        ...
        // Used to get rid of duplicate vertices
        ...
        for (const auto& shape : shapes) {
            for (const auto& index : shape.mesh.indices) {
                ...
                vertex.texCoord = {
                    ...
                    1.0 - attrib.texcoords[2 * index.texcoord_index + 1]    // inverted formet of OpenGL
                };
